...
impl DiskInode {
    ...
    pub fn initialize(&mut self, type_: DiskInodeType) {
        self.size = 0;
        // the reference_cnt is count by DirEntry
        // if DirEntry.inode_id eq DiskInode, reference_cnt++
        self.ref_cnt = 0;
    ...
    /// inner_id is the Logical block number within the file (0 for first block, 1 for second, etc.)
    /// you can view `inner_id` as file offset
